...
item1 = Item(name='Jersey', description='Description1', 
			date_time=randomTime(), category=category1)
session.add(item1)
session.commit()
...
item5 = Item(name='Bat', description='Description5',
			date_time=randomTime(), category=category3)
session.add(item5)
session.commit()
...
item6 = Item(name='Frisbee', description='Description6',
			date_time=randomTime(), category=category4)
session.add(item6)
session.commit()
...
item7 = Item(name='Googles', description='Description7',
			date_time=randomTime(), category=category5)
session.add(item7)
session.commit()
...
item9 = Item(name='Stick', description='Description9',
			date_time=randomTime(), category=category9)
session.add(item9)
session.commit()
